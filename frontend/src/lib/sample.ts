...
export const sampleContent: PosterContent = {
  ...
  flow: [{ title: 'Key input', detail: '"name" enters hash()' }, { title: 'Index access', detail: 'Hash points to bucket 2' }, { title: 'Value found', detail: 'Entry contains Alice' }, { title: 'Result', detail: 'data["name"] → Alice' }],
}
